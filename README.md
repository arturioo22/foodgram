...
Автоматически применяется скрипт (setup_db.sh) для наполнения БД ингредиентами.
Так же скрипт создает предустановленные теги, тестовых пользователей и рецепты.
